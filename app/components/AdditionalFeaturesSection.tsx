      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">We've fine-tuned our AI using thousands of actual, high-quality student submissions—so it understands what works, not just what sounds good.</p>
                </div>
              </div>
          ...
          <div className="relative">
            <div className="w-full h-80 bg-gradient-to-br from-green-50/60 to-green-100/40 rounded-3xl backdrop-blur-sm border border-green-200/50 shadow-2xl">
              <div className="p-6 h-full flex flex-col justify-center">
                ...
                <div className="mt-6 text-center">
                  <div className="inline-flex items-center space-x-2 px-4 py-2 bg-green-50 rounded-full border border-green-200">
                    ...
                    <span className="text-sm font-medium text-green-700">AI-Powered Excellence</span>
                  </div>
                </div>
              </div>
            </div>
