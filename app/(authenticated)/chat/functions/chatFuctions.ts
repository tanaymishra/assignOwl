...
import { Message, Artifact } from "../store/chatStore"


export const generateSampleAssignmentContent = () => {
  return `
...
export const handleSubmit = async () => {
  const { inputValue, attachedFiles, addMessage, clearInput, setIsLoading, updateMessageArtifact } = useChatStore.getState()
